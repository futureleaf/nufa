			<?php
			// untuk update
			foreach($achievement_update as $achievement) {
						...
						<div class="box-content">
							<fieldset>
									...
									<div class="control-group <?php if(form_error('name_content') != null) echo"error" ?>">
										...
										<div class="controls">
											<input type="text" class="span6 typeahead" name="name_content" value="<?php echo (set_value('name_content'))?set_value('name_content'):$achievement->name_content; ?>">
									...
									<div class="control-group <?php if(form_error('desc_content') != null) echo"error" ?>">
										...
										<div class="controls">
											<textarea class="cleditor" rows="3" name="desc_content"><?php echo (set_value('desc_content'))?set_value('desc_content'):$achievement->desc_content; ?></textarea>
