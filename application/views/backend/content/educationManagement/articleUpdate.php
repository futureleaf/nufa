						...
						<div class="box-content">
							<fieldset>
									...
									<!--<div class="control-group">
										...
										<div class="controls">
											<?php 
												echo form_dropdown("id_tcontent", $tcontentses, $article->id_tcontent, 'data-rel="chosen"'); 
											?>
										</div>
									</div>-->
									<div class="control-group <?php if(form_error('name_content') != null) echo"error" ?>">
										...
										<div class="controls">
											<input type="text" class="span6 typeahead" name="name_content" value="<?php echo (set_value('name_content'))?set_value('name_content'):$article->name_content; ?>">
