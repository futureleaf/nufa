						...
						<div class="row-fluid sortable">
							<div class="box span12">
								...
								<div class="box-content">
									<fieldset>
											<input type="hidden" name="parent_contact" value="<?php echo $contact->parent_comment ?>" />
											<div class="control-group <?php if(form_error('author_comment') != null) echo"error" ?>">
												...
												<div class="controls">
													<input type="text" class="span4 typeahead" name="author_comment" value="<?php echo (set_value('author_comment'))?set_value('author_comment'):$contact->author_comment; ?>">
											...
											<div class="control-group <?php if(form_error('email_comment') != null) echo"error" ?>">
												...
												<div class="controls">
													<input type="email" class="span4 typeahead" name="email_comment" value="<?php echo (set_value('email_comment'))?set_value('email_comment'):$contact->email_comment; ?>">
											...
											<div class="control-group <?php if(form_error('phone_comment') != null) echo"error" ?>">
												...
												<div class="controls">
													<input type="text" class="span4 typeahead" name="phone_comment" value="<?php echo (set_value('phone_comment'))?set_value('phone_comment'):$contact->phone_comment; ?>">
											...
											<div class="control-group <?php if(form_error('desc_comment') != null) echo"error" ?>">
												...
												<div class="controls">
													<textarea rows="3" style="width:40%;" name="desc_comment"><?php echo (set_value('desc_comment'))?set_value('desc_comment'):$contact->desc_comment; ?></textarea>
