								...
								<div class="box-content">
									<fieldset>
											...
											<div class="control-group <?php if(form_error('desc_comment') != null) echo"error" ?>">
												...
												<div class="controls">
													<textarea rows="6" style="width:50%" name="desc_comment"><?php echo (set_value('desc_comment'))?set_value('desc_comment'):""; ?></textarea>
											...
											<div class="form-actions">
												...
												<?php echo '<a href="#'.base_url().'admin/diamondWord/view/'.$id_comment.'" class="btn">Kembali</a>'; ?>
											</div>
									</fieldset>
								</div>
							</div><!--/span-->
