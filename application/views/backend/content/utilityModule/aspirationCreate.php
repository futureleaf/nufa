								...
								<div class="box-content">
									<fieldset>
											...
											<div class="control-group <?php if(form_error('name_comment') != null) echo"error" ?>">
												...
												<div class="controls">
													<input type="text" class="span4 typeahead" name="name_comment" value="<?php echo (set_value('name_comment'))?set_value('name_comment'):""; ?>">
											...
											<div class="form-actions">
												...
												<?php echo '<a href="#'.base_url().'admin/aspiration/view/'.$id_comment.'" class="btn">Kembali</a>'; ?>
											</div>
									</fieldset>
								</div>
							</div><!--/span-->
