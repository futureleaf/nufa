				<?php
				// untuk update
				foreach($diamondWords as $diamondWord) {
						...
						<div class="row-fluid sortable">
							<div class="box span12">
								...
								<div class="box-content">
									<fieldset>
											<input type="hidden" name="parent_diamondWord" value="<?php echo $diamondWord->parent_comment ?>" />
											<div class="control-group <?php if(form_error('author_comment') != null) echo"error" ?>">
												...
												<div class="controls">
													<input type="text" class="span4 typeahead" name="author_comment" value="<?php echo (set_value('author_comment'))?set_value('author_comment'):$diamondWord->author_comment; ?>">
											...
											<div class="control-group <?php if(form_error('email_comment') != null) echo"error" ?>">
												...
												<div class="controls">
													<input type="email" class="span4 typeahead" name="email_comment" value="<?php echo (set_value('email_comment'))?set_value('email_comment'):$diamondWord->email_comment; ?>">
											...
											<div class="control-group <?php if(form_error('desc_comment') != null) echo"error" ?>">
												...
												<div class="controls">
													<textarea rows="6" style="width:50%" name="desc_comment"><?php echo (set_value('desc_comment'))?set_value('desc_comment'):$diamondWord->desc_comment; ?></textarea>
											...
											<div class="form-actions">
												...
												<?php echo '<a href="#'.base_url().'admin/diamondWord" class="btn">Kembali</a>'; ?>
											</div>
									</fieldset>
								</div>
							</div><!--/span-->
