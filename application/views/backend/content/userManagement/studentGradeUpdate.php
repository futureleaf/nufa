								...
								<div class="box-content">
										<fieldset>			
											...
											// untuk craete
												...
												foreach($grade_records as $grade):
											?>
													...
													<div class="control-group <?php if(form_error('name_grade') != null) echo"error" ?>">
														...
														<div class="controls">
															<input type="text" style="width:30.5%" name="name_grade" value="<?php echo (set_value('name_grade'))?set_value('name_grade'):$grade->name_grade; ?>" />
													...
													<div class="control-group <?php if(form_error('grade') != null) echo"error" ?>">
														...
														<div class="controls">
															<input type="text" style="width:5.5%" name="grade" value="<?php echo (set_value('grade'))?set_value('grade'):$grade->grade; ?>" />
													...
													<div class="control-group <?php if(form_error('desc_grade') != null) echo"error" ?>">
														...
														<div class="controls">
															<textarea name="desc_grade"><?php echo (set_value('desc_grade'))?set_value('desc_grade'):$grade->desc_grade; ?></textarea>
															<?php if(form_error('desc_grade') != null) echo "<span class=\"help-inline\"> " . form_error('desc_grade') . " </span>"; ?>
														</div>
													</div>
													<div class="form-actions">
														<button type="submit" class="btn btn-primary" name="doUpdate">Save</button>
