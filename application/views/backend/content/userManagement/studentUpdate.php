								...
								<div class="box-content">
										<fieldset>			
											...
											?>
													...
													<input type="hidden" name="id_class" value="<?php echo $student->id_class; ?>" />
													<div class="control-group <?php if(form_error('full_name') != null) echo"error" ?>">
														<label class="control-label">Nama <?php echo $_title; ?></label>
														<div class="controls">
															<input type="text" style="width:30.5%" name="full_name" value="<?php echo (set_value('full_name'))?set_value('full_name'):$student->full_name; ?>" />
													...
													<div class="control-group <?php if(form_error('parent_name') != null) echo"error" ?>">
														...
														<div class="controls">
															<input type="text" style="width:30.5%" name="parent_name" value="<?php echo (set_value('parent_name'))?set_value('parent_name'):$student->parent_name; ?>" />
													...
													<div class="control-group <?php if(form_error('email') != null) echo"error" ?>">
														...
														<div class="controls">
															<input type="email" style="width:30.5%" name="email" value="<?php echo (set_value('email'))?set_value('email'):$student->email; ?>" />
													...
													<div class="control-group <?php if(form_error('repeat_email') != null) echo"error" ?>">
														...
														<div class="controls">
															<input type="email" style="width:30.5%" name="repeat_email" value="<?php echo (set_value('repeat_email'))?set_value('repeat_email'):$student->email; ?>" />
													...
													?>
														<input type="hidden" name="old_password" value="<?php echo $this->encrypt->decode($student->password); ?>" />
													<?php
													}
													else {
													?>
													...
													<div class="control-group <?php if(form_error('no_jenjang') != null) echo"error" ?>">
														...
														<div class="controls">
															<input type="text" style="width:30.5%" name="no_jenjang" value="<?php echo (set_value('no_jenjang'))?set_value('no_jenjang'):$student->no_jenjang; ?>" />
													...
													<div class="control-group <?php if(form_error('nis') != null) echo"error" ?>">
														...
														<div class="controls">
															<input type="text" style="width:30.5%" name="nis" value="<?php echo (set_value('nis'))?set_value('nis'):$student->nis; ?>" />
													...
													<div class="control-group <?php if(form_error('nisn') != null) echo"error" ?>">
														...
														<div class="controls">
															<input type="text" style="width:30.5%" name="nisn" value="<?php echo (set_value('nisn'))?set_value('nisn'):$student->nisn; ?>" />
													...
													<div class="control-group">
														...
														<div class="controls">
															<?php
																...
																echo form_dropdown("is_auser", $is_ausers, $student->is_auser, 'data-rel="chosen"'); 
															?>
														</div>
													</div>
													<div class="control-group">
														...
														<div class="controls">
															<?php 
																...
																echo form_dropdown("id_city", $citieses, $student->id_city, 'data-rel="chosen"'); 
															?>
														</div>
													</div>
													<div class="control-group">
													...
													<div class="control-group">
														...
														<div class="controls">
															<?php
																$genders['1'] = "Laki-laki";
																$genders['0'] = "Perempuan";
																echo form_dropdown("gender", $genders, $student->gender, 'data-rel="chosen"'); 
															?>
														</div>
													</div>
													<div class="control-group <?php if(form_error('born_date') != null) echo"error" ?>">
														...
														<div class="controls">
															<input class="datepicker" type="text" style="width:30.5%" name="born_date" value="<?php echo (set_value('born_date'))?set_value('born_date'):$this->method->dateFromDatabase($student->born_date); ?>" />
													...
													<div class="control-group <?php if(form_error('address') != null) echo"error" ?>">
														...
														<div class="controls">
															<textarea rows="3" name="address"><?php echo (set_value('address'))?set_value('address'):$student->address; ?></textarea>
													...
													<div class="control-group <?php if(form_error('desc_user') != null) echo"error" ?>">
														...
														<div class="controls">
															<textarea class="cleditor" rows="3" name="desc_user"><?php echo (set_value('desc_user'))?set_value('desc_user'):$student->desc_user; ?></textarea>
