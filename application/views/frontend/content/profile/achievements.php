						...
						<div class="photos-blog"><!--beginning photos-blog--> 
							...
							<div class="intro-text-blog"><!--beginning intro-text-blog-->
							  ...
							  <?php echo anchor("$controller/$link/$achievement->id_content", '<h3 class="title-three-4"><span>'.$achievement->name_content.' </span></h3>'); ?>
								...
								<p class="doc-post"> 
									<span class="time-post"><img src="<?=$dir_images?>calendar_alt_fill_16x16.png" style="width:2.5%" alt=""> <?php echo anchor("$controller/$link/$achievement->id_content", $this->method->dateFromDatabaseText($achievement->ud_content)); ?></span> 
									<span class="admin-post">
										<?php echo ($achievement->gender != 0 || $achievement->gender == null)? '<img src="'.$dir_images.'user_12x16_grey.png" style="width:2.5%" alt="">' : '<img src="'.$dir_images.'user-woman_12x14_grey.png" style="width:2.5%" alt="">';?> 
										<?php echo anchor("$controller/$link/$achievement->id_content", ($achievement->id_user ==null)?"Admin":$achievement->full_name); ?>
									</span> 
									<span class="comment-post"><img src="<?=$dir_images?>comment_stroke_16x14.png" style="width:2.5%" alt=""> <?php $count_comments = $this->mdl_comment->count_id_content_records($achievement->id_content); echo anchor("$controller/$link/$achievement->id_content", ($count_comments == 1)?$count_comments . " Comment":$count_comments . " Comments"); ?></span> 
