		...
		<article class="item-content-blog"><!--beginning item-content-blog--> 
			...
			?>
				<form action="" method="post" enctype="multipart/form-data">
					...
					<input type="hidden" name="id_user" value="<?php echo $this->session->userdata("id_user_front");?>" />
					<table>
						<tr>
							...
							<td>
								<?php
									...
									echo form_dropdown("id_rcontent", $rpostRecord,  $article->id_rcontent, 'data-rel="chosen"');
								?>
							</td>
						</tr>
						<tr>
							...
							<td>:</td>
							<td>
								<input type="text" name="name_content" value="<?php echo (set_value('name_content'))?set_value('name_content'):$article->name_content; ?>" />
						...
						<tr>
							...
							<td>:</td>
							<td>
								<input type="checkbox" name="change_photo" value="TRUE"  /> Rubah photo<br/>
						...
						<tr>
							...
							<td>:</td>
							<td>
								<textarea class="cleditor" rows="3" name="desc_content"><?php echo (set_value('desc_content'))?set_value('desc_content'):$article->desc_content; ?></textarea>
						...
						<tr>
							...
							<td></td>
							<td>
								<input type="submit" name="doUpdate" value="Posting"/>
