$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','/backend/css/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	$('ul.gallery li').hover(function(){
		...
		$(this).append('<div class="well gallery-controls">'+
							'<p><a href="#" class="gallery-edit btn"><i class="icon-edit"></i></a> <a href="<?php echo "tidak ada"; ?>" class="gallery-delete btn"><i class="icon-remove"></i></a></p>'+
						'</div>');
