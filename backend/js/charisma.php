$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','/application/views/backend/css/bootstrap-'+theme_name+'.css');
	}
...
// <a href="#" class="gallery-delete btn"><i class="icon-remove"></i></a>
	//gallery controlls container animation
	$('ul.gallery li').hover(function(){
		$('img',this).fadeToggle(1000);
		$(this).find('.gallery-controls').remove();
		$(this).append('<div class="well gallery-controls">'+
							'<p><a href="#<?php echo $picture->id_picture . "admin/gallery/pictureDelete/"; ?>" class="gallery-edit btn"><i class="icon-edit"></i></a> <a href="#" class="gallery-delete btn"><i class="icon-remove"></i></a></p>'+
						'</div>');
